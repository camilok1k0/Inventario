...
<head>
    ...
    <title>Sistema para la Gestion de Inventarios PEPS</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
        <a class="navbar-brand" href="<?php echo base_url(); ?>admin/listar">Menu Principal</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <?php } ?>
                        <a class="nav-link active" href="<?php echo base_url(); ?>proveedores/listar">
                            <div class="sb-nav-link-icon"><i class="fas fa-book fa-lg"></i></div>
                            Proveedores
                        </a>
                            <a class="nav-link active" href="<?php echo base_url(); ?>alertasdecaducidad">
                                <div class="sb-nav-link-icon"><i class="fas fa-exclamation-triangle fa-lg"></i></div>
                                Alertas de Caducidad
                        </a><a class="nav-link active" href="<?php echo base_url(); ?>tarjetaalmacenaje">
                            <div class="sb-nav-link-icon"><i class="fas fa-box fa-lg"></i>
                            </div>
                            Tarjetas Almacenaje
                        </a>
                        <?php if ($_SESSION['rol'] == 1) { ?>
                        ...
                        <div class="collapse" id="collapseEst" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link active" target="_blank" href="<?php echo base_url(); ?>AlertasCaducidad/listar">Tarjeta de Almacenaj</a>
